...
//    public static final String SERVER_ADDR = "128.134.144.162";
    
    // API 서버 포트
//    public static final int API_SERVER_PORT = 8403;
    public static final int API_SERVER_PORT = 8401;
    ...
    public static Class Activity_CLASS = com.geurimsoft.bokangnew.view.ActivityMain.class;
